...
public class BaritoneReturnStrategy {
    ...
    private void setSetting(String name, Object value) {
        try {
            ...
            System.err.println("[MSF] Failed to set Baritone setting " + name + ": " + e.getMessage());
        }
    }
    ...
    public void startPathfinding(double x, double y, double z) {
        try {
            ...
            System.out.println("[MSF] Baritone pathfinding started to " +
                    (int) x + ", " + (int) y + ", " + (int) z);
        } catch (Exception e) {
            System.err.println("[MSF] Baritone startPathfinding failed: " + e.getMessage());
    ...
    public void cancel() {
        try {
            ...
            System.err.println("[MSF] Baritone cancel failed: " + e.getMessage());
        }
    }
